...
<li>Deje de adivinar en la capacidad.</li>
<li>Incremento en la velocidad y agilidad.</li>
...
<p><strong>Amazon Simple Storage Service Amazon S3</strong> es un servicio de lmacenamiento de objetos que ofrece escalabilidad, disponibilidad de datos, seguridad y rendimiento.  <strong>Es un servicio Global.</strong></p>
<ul>
...
<p><img src="https://p2zk82o7hr3yb6ge7gzxx4ki-wpengine.netdna-ssl.com/wp-content/uploads/AWS-ASGs-2.png" alt="enter image description here"></p>
<p>Amazon EC2 Auto Scaling lo ayuda a mantener la disponibilidad de las aplicaciones y le permite agregar o eliminar instancias EC2 automáticamente con base a la demanda de su aplicación.</p>
<h1 id="route-53">Route 53</h1>
<p><img src="https://i2.wp.com/bhargavamin.com/wp-content/uploads/2016/03/Amazon-Route-53.png?resize=640,510&amp;ssl=1" alt="enter image description here"></p>
<p><strong>Amazon Route 53</strong> es un <a href="https://aws.amazon.com/es/route53/what-is-dns/">servicio de DNS (sistema de nombres de dominio)</a> web escalable y de alta disponibilidad en la nube. Está diseñado para ofrecer a los desarrolladores y las empresas un método fiable y rentable para redirigir a los usuarios finales a las aplicaciones en Internet mediante la traducción de nombres legibles. <strong>Es un servicio global</strong></p>
<h1 id="elastic-beanstalk">Elastic Beanstalk</h1>
<p><img src="https://hackernoon.com/images/s1vm27tb.jpg" alt="enter image description here"></p>
<p>AWS Elastic Beanstalk es un servicio fácil de utilizar para implementar y escalar servicios y aplicaciones web desarrollados con Java, .NET, PHP, Node.js, Python, Ruby, Go y Docker en servidores familiares como Apache, Nginx, Passenger e IIS. Solo tiene que cargar el código y Elastic Beanstalk administrará de manera automática la implementación, desde el aprovisionamiento de la capacidad, el equilibrio de carga y el escalado automático hasta la monitorización del estado de la aplicación.</p>
<h1 id="cloudformation-1">CloudFormation</h1>
<p><img src="https://www.coletiv.com/static/9b2c65249d5a266da894957c178faceb/6050d/how-to-use-aws-cloud-formation-to-setup-the-infrastructure-for-a-static-website.png" alt="enter image description here"></p>
<p>AWS CloudFormation le ofrece una forma sencilla de modelar un conjunto de recursos relacionados de AWS y de terceros, aprovisionarlos de manera rápida y consistente y administrarlos a lo largo de sus ciclos de vida tratando la infraestructura como un código.</p>
<h1 id="systems-manager">Systems Manager</h1>
<p><img src="https://bluechiptek.com/wp-content/uploads/2018/12/image-5.png" alt="enter image description here"></p>
<p>AWS Systems Manager le brinda visibilidad y control para su infraestructura en AWS. Systems Manager puede ver los datos operativos de varios servicios de AWS y le permite automatizar tareas operativas en todos sus recursos.</p>
<ul>
<li>Podría ejecutar un comando o una instrucción a un grupo de instancias.</li>
<li>Puede ser usado para administrar flotas de instancias EC2.</li>
</ul>
<h1 id="cloudwatch">CloudWatch</h1>
<p><strong>Amazon CloudWatch</strong> es un servicio de monitorización ofrece datos e información procesable para monitorizar sus aplicaciones, responder a cambios de rendimiento que afectan a todo el sistema, optimizar el uso de recursos y lograr una vista unificada del estado de las operaciones. CloudWatch recopila datos de monitorización y operaciones en formato de registros, métricas y eventos.</p>
<ul>
<li>Monitorear el rendimiento.</li>
<li>Monitorea cada servicio que se ejecuta dentro de AWS.</li>
<li>Puedes crear alarmas con triggers y crear notificaciones.</li>
</ul>
<h1 id="servicios-globales-de-aws">Servicios globales de AWS</h1>
<ol>
<li>IAM</li>
<li>Route53</li>
<li>CloutFront</li>
<li><a href="https://aws.amazon.com/es/sns/?whats-new-cards.sort-by=item.additionalFields.postDateTime&amp;whats-new-cards.sort-order=desc">SNS</a> (Simple Notification Service)</li>
<li><a href="https://aws.amazon.com/es/ses/">SES</a> (Simple Email Service)</li>
<li>S3 <strong>(Regional)</strong></li>
</ol>
<h1 id="¿que-servicios-puedo-utilizar-en-las-instalaciónes">¿Que servicios puedo utilizar en las instalaciónes?</h1>
<ol>
<li><a href="https://aws.amazon.com/es/snowball/?whats-new-cards.sort-by=item.additionalFields.postDateTime&amp;whats-new-cards.sort-order=desc">Snowball</a></li>
<li><a href="https://docs.aws.amazon.com/es_es/snowball/latest/developer-guide/whatisedge.html">Snowball Edge</a></li>
<li><a href="https://aws.amazon.com/es/storagegateway/?whats-new-cards.sort-by=item.additionalFields.postDateTime&amp;whats-new-cards.sort-order=desc">Storage Gateway</a></li>
<li><a href="https://aws.amazon.com/es/codedeploy/">CodeDeploy</a></li>
<li><a href="https://aws.amazon.com/es/opsworks/">OpsWorks</a></li>
<li><a href="https://aws.amazon.com/es/greengrass/">IoT Greengrass</a></li>
</ol>
